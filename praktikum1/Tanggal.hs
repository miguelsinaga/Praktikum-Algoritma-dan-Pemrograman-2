...
makeTanggal a b c = Tanggal a b c
-- TODO
...
hariDalamBulan b t =
    if b == 2 then
        ...
        if b == 1 || b == 3 || b == 5 || b == 8 || b == 10 || b == 12 then 31
        else 30
...
isValid :: Tanggal -> Bool
isValid a = tahun a >= 1 && bulan a >= 1 && bulan a <= 12 && hari a >= 1 && hari a <= hariDalamBulan (bulan a) (tahun a)

...
countPathSum Empty _ = 0
countPathSum (Node val Empty Empty) target =
  if val == target then 1 else 0
countPathSum (Node val l r) target =
  countPathSum l (target - val) + countPathSum r (target - val)
{-
Contoh 1:
Pohon:
         5
